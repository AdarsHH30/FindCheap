...
export function RegisterForm({
  ...
  description = "Join FindCheap to track prices, save your favorite searches, and get notified when deals drop.",
  ...props
}: RegisterFormProps) {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 text-center sm:text-left">
        {/* <div className="inline-flex w-max items-center gap-2 rounded-full bg-primary/10 px-3 py-1 text-xs font-medium text-primary">
      ...
      <div className="grid gap-6">
        ...
        >
          ...
          {isLoading ? "Please wait" : "Sign up with GitHub"}
        </Button>
      </div>
